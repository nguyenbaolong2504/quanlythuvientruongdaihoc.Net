...
namespace GUI
{
    public partial class XuatFileTra : Form
    {
        public XuatFileTra()
        {
            InitializeComponent();
        ...
        private void XuatFileTra_Load(object sender, EventArgs e)
        {
        ...
        private void dgv_tra_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        {
            exprot2Excel(dgv_tra, @"D:\", "XuatfieltraSachTra");
        }
    }
}
